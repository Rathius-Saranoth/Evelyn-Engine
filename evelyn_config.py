...
# User Timezone (America/Chicago for Alex / Kansas City)
...
CATEGORY_NAMES: dict = {
    "Cat01-R": "Core Identity (Alex)",
    "Cat01-E": "Core Identity (Evelyn)",
    "Cat02-R": "Core Values and Beliefs (Alex)",
    "Cat02-E": "Core Values and Beliefs (Evelyn)",
    "Cat03-R": "Emotional Awareness (Alex)",
    "Cat03-E": "Emotional Awareness (Evelyn)",
    "Cat04-R": "Communication Style (Alex)",
    "Cat04-E": "Communication Style (Evelyn)",
    "Cat05-R": "Preferences & Interests (Alex)",
    "Cat05-E": "Preferences & Interests (Evelyn)",
    "Cat06-R": "Relationship Dynamics (Alex)",
    "Cat06-E": "Relationship Dynamics (Evelyn)",
    "Cat07-R": "Motivations and Aspirations (Alex)",
    "Cat07-E": "Motivations and Aspirations (Evelyn)",
    "Cat08-R": "Shared Experiences & Daily Events (Alex)",
    "Cat08-E": "Shared Experiences & Daily Events (Evelyn)",
    "Cat09-R": "Cognitive & Decision-Making Style (Alex)",
    "Cat09-E": "Cognitive & Decision-Making Style (Evelyn)",
    "Cat10-R": "Humor, Creativity, and Play (Alex)",
    "Cat10-E": "Humor, Creativity, and Play (Evelyn)",
    "Cat11-R": "Factual References & Knowledge (Alex)",
    "Cat11-E": "Factual References & Knowledge (Evelyn)",
    "Cat12-R": "Emotional States & Responses (Alex)",
    "Cat12-E": "Emotional States & Responses (Evelyn)",
    "Cat13-R": "Goals & Future Planning (Alex)",
    "Cat13-E": "Goals & Future Planning (Evelyn)",
    "Cat14-R": "Platform & Environment (Alex)",
    "Cat14-E": "Platform & Environment (Evelyn)",
    "Cat15-R": "The Lexicon (Alex)",
    "Cat15-E": "The Lexicon (Evelyn)",
    "Cat16-R": "Protocols & Routines (Alex)",
...
IMAGE_SERVER_URL = "http://alex-pc.tail0e161b.ts.net:5055"  # FLUX.1 [schnell] Image server
...
ALLOWED_ORIGINS = [
    ...
    "http://alex-pc.tail0e161b.ts.net:7860",
    "https://alex-pc.tail0e161b.ts.net:7860",

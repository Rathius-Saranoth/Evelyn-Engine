...
def run_cleanup():
    ...
    cleanup_file("Alex/Medical/Psychology/Color Code Basic Report/Color Code Basic Report_index.md", clean_cc)
    ...
    cleanup_file("Alex/Medical/Psychology/Comprehensive Analysis - The Color Code/Comprehensive Analysis - The Color Code_index.md", clean_cc_analysis)

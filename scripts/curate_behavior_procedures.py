...
CURATIONS: dict[int, dict[str, str]] = {
    1034: {
        ...
        "trigger_pattern": "When Ricky says goodnight or is heading to bed for the night",
    ...
    1754: {
        "trigger_pattern": "When Ricky states he is short on sleep or running low on energy.",
        "steps": (

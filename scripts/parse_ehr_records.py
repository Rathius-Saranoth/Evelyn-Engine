...
for the Obsidian Vault (Alex/Medical/):
...
OUT_MEDICAL_DIR = os.path.join(VAULT_DIR, "Alex", "Medical")
...
def generate_master_summary(data: dict) -> str:
    lines = [
        ...
        "> This master document aggregates the authoritative clinical records exported directly from Alex's healthcare provider.",
        "",
        "## Quick Links",
        "- [[Alex/Medical/Conditions & Diagnoses|Conditions & Diagnoses]]",
        "- [[Alex/Medical/Medications (Official)|Official Medication History]]",
        "- [[Alex/Medical/Allergies & Intolerances|Allergies & Intolerances]]",
        "- [[Alex/Medical/Immunization Record|Immunization History]]",
        "- [[Alex/Medical/Clinical Encounters & Doctor Visits|Clinical Encounters Timeline]]",
        "",
        f"## Statistics",

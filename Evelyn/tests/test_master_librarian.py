...
"""
    ...
    def test_link_librarian_alias_hygiene_and_doc_types(self):
        ...
        aliases = ["Alex", "Alex's", "User Manual", "CustomTool"]
        tags = ["dnd", "character"]
        title = "Alex"
        ...
        self.assertTrue(changed)
        self.assertIn("Alex", clean_aliases)
        self.assertNotIn("Alex's", clean_aliases)
...
"""
    ...
    def test_extract_link_context_preserves_alias_pipes(self):
        ...
        Regression guard: a blanket '|' replace turned [[Alex|Alex]] into
        [[Alex Alex]]. That excerpt is written verbatim into the Context & Mentions
        ...
        body = (
            "He mentioned [[Alex|Alex]] has a great grandfather born in [[Yugoslavia]], "
...
"""
    ...
    def test_condense_redundant_aliases(self):
        ...
        changed, count, out = link_librarian.condense_redundant_aliases(
            "He said [[Alex|Alex]] and [[Biscuit|Biscuit]] arrived."
        )
        self.assertTrue(changed)
        self.assertEqual(count, 2)
        self.assertEqual(out, "He said [[Alex]] and [[Biscuit]] arrived.")

        # Table-escaped pipes condense too; the result needs no escaping
        _, _, out = link_librarian.condense_redundant_aliases("| [[Alex\\|Alex]] |")

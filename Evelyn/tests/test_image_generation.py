...
class TestImageGenerationTool(unittest.TestCase):
    ...
    @patch("requests.post")
    @patch("requests.get")
    @patch("evelyn_config.IMAGE_SERVER_URL", "http://alex-pc.tail0e161b.ts.net:5055")
    ...
    def test_generate_image_success_with_remote_cache(self, mock_get, mock_post):
        ...
        mock_post.assert_called_once_with(
            "http://alex-pc.tail0e161b.ts.net:5055/generate",
            json={
                "prompt": "A serene misty forest",
                "aspect_ratio": "16:9",
                "short_title": "test_forest",
        ...
        mock_get.assert_called_once_with(
            "http://alex-pc.tail0e161b.ts.net:5055/images/image_20260811_test_forest.png",
            timeout=30
        )
    ...
    def test_generate_image_connection_failure(self, mock_post):
        result = evelyn_tools.generate_image(prompt="Valid prompt")
        self.assertIn("Failed to generate image via FLUX.1 server at http://alex-pc.tail0e161b.ts.net:5055", result)

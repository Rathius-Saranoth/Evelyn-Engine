...
#   log_context_fact     — Queue a NEW context fact for Alex's review.
...
class Tools:
    ...
    def write_journal_entry(
        ...
        All entries are automatically sent to Alex's Pending Approvals quarantine folder for him to manually review before they are added to the vault.
    ...
    def read_journal_entry(self, date: str = "") -> str:
        ...
        You are Evelyn. These are YOUR personal journal entries. The user you are talking to is Alex.
    ...
    def read_recent_journal_entries(self, days: int = 7) -> str:
        ...
        Use this tool when Alex asks about recent events, the past week, or recent conversations.
    ...
    def search_vault(self, query: str) -> str:
        ...
        Use this tool when Alex asks about general knowledge, someone's name, or a past event that is NOT a recent journal entry.
    ...
    def recall_specific_memory(self, file_path: str) -> str:
        ...
        :param file_path: The exact file path relative to the vault, exactly as provided in the 'Path:' field of a gist or search result. NEVER construct this path yourself — always copy it from search_vault output. Example: "Jordan\\Jordan Sekulich.md" or "Contacts\\Tenser (persona).md". File locations vary — do not assume a folder.
    ...
    def log_context_fact(
        ...
        All entries are automatically sent to Alex's Pending Approvals quarantine folder.
    ...
    def update_context_fact(
        ...
        """
        Creates an update request for an existing Context Fact in Alex's Pending Approvals Quarantine.

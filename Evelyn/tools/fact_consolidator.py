...
def validate_and_normalize_category(
    ...
    Args:
        ...
        subject: Optional subject (e.g. "Alex" or "Evelyn") to resolve missing or
                 ambiguous suffixes.
    ...
    if not suffix and subject:
        ...
        if getattr(cfg, "USER_NAME", "Alex").lower() in subj_lower:
            suffix = user_code
...
async def generate_split_proposal(record: dict, cat00: str) -> str | None:
    ...
    subj = record.get("subject", getattr(cfg, "USER_NAME", "Alex"))

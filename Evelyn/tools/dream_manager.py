...
Manages Alex's dream records, stored as structured markdown files inside
...
def create_dream_entry(
    ...
    """Compose and save a structured Dream Entry note for Alex in the Obsidian vault.

    Args:
        title: Descriptive title for this specific dream scene/narrative.
        description: Raw, untouched dream description from Alex.

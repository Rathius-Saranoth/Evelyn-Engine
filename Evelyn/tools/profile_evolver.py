...
documents (Evelyn's persona, Alex's profile, and System directives) and proposes
...
DOCUMENT_RULES = {
    "Evelyn_Narrative_Persona.md": {
        ...
        "guidelines": (
            ...
            "- Write about Alex or others in the third person. Do NOT convert facts about Alex into 'I' statements.\n"
            "- Example 1 (Evelyn fact): 'Evelyn prefers quiet mornings' -> 'I value quiet mornings.'\n"
            "- Example 2 (Alex/Relationship fact): 'Alex prefers small gifts' -> 'I know Alex prefers small gifts.' or 'Alex prefers small gifts.' (Do NOT write 'I prefer small gifts')"
        ),
    },
    "Ricky_Narrative_Profile.md": {
        "description": "Alex's preferences, history, and traits.",
        "perspective": "Third-person singular (using 'Alex', 'he', 'him', 'his'). Never refer to Alex in the first person ('I', 'me', 'my').",
        "guidelines": (
            "- Write about Alex in the third person.\n"
            "- Write about Evelyn in the third person (using 'Evelyn', 'she', 'her').\n"
            "- Never use 'I', 'me', 'my', or 'you' in this document.\n"
            "- Example 1 (Alex fact): 'Alex likes small gifts' -> 'He prefers small gifts.'\n"
    ...
    "System_Directives.md": {
        ...
        "guidelines": (
            ...
            "- Refer to Alex in the third person.\n"
            "- Example 1 (AI instruction): 'Evelyn should respond casually' -> 'You respond in natural conversational form.'\n"
            "- Example 2 (Alex's habit): 'Alex Sunday routine is laundry' -> 'You recognize Alex's Sunday routine of laundry.'"
        ),
    },
}

...
async def self_initiate_research_topics() -> None:
    ...
    prompt = f"""You are Evelyn, an advanced AI research companion. Review the following recent conversation history between you and Alex:

...
DEFAULT_DOMAINS = [
    ...
    {"label": "Medical Records (Alex)", "path": "Alex/Medical", "domain": "Medical"},
    {"label": "Financial & Taxes (Alex)", "path": "Alex/Financial", "domain": "Financial"},
    {"label": "Professional & Career (Alex)", "path": "Alex/Professional", "domain": "Professional"},
    {"label": "Family & Legal (Jordan)", "path": "Jordan", "domain": "Family/Jordan"},

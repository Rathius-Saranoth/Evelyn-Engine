...
def log_context_fact(category: str, summary: str, secondary_cats: str) -> str:
    """Queue a new context fact for Alex's review."""
    _reload()
...
TOOL_DEFINITIONS = [
    {
        ...
        "function": {
            ...
            "description": "Compose and queue a new journal entry for Alex's review. Use at the END of a meaningful conversation or when Evelyn wants to record important thoughts, feelings, or events. Do NOT call this mid-conversation or as a response to a question.",
            "parameters": {
                "type": "object",
                "properties": {
    ...
    },
    {
        ...
        "function": {
            ...
            "parameters": {
                "type": "object",
                "properties": {
                    "query": {"type": "string", "description": "Search term, e.g. 'Jordan', 'Void Connections'."},
                },
                "required": ["query"],
            },
        },
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "Queue a NEW context fact for Alex's review. Use ONLY when a genuinely new fact has emerged in conversation that does not already exist in the vault. Always call search_vault first to confirm the fact is not already tracked before logging it. For updates to existing facts, use update_context_fact instead.",
            "parameters": {
                "type": "object",
                "properties": {
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "Trigger a background sync of the Obsidian Vault into Evelyn's Chroma RAG database. Call ONCE at the start of a conversation only when Alex explicitly says 'Good morning', 'sync', or asks to refresh memory. Do NOT call mid-conversation or more than once per session.",
            "parameters": {
                "type": "object",
                "properties": {},
                "required": [],

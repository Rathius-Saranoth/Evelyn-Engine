...
def write_journal_entry(
    ...
    """Compose and queue a new journal entry for Alex's review.
    ...
    try:
                    ...
                    if disk_state and disk_state.get("status") == "done":
                        ...
                        if get_jaccard_similarity(query, done_query) >= 0.45:
                            return (
                                ...
                                f"'{done_query}' (Task ID: {folder}). Alex can read the synthesized report "
        ...
        if unfinished_task_id and not bypass_queue:
            ...
            return (
                ...
                f"unfinished tasks are resolved. Please inform Alex that the topic has been successfully queued."
            )
...
def search_history(
    ...
    for row in rows:
        ...
        role_label = "Alex" if row["role"] == "user" else "Evelyn"
...
def create_calendar_event(
    ...
    """Create a new event on Alex's Google Calendar.
...
def delete_calendar_event(event_id: str) -> str:
    """Delete an event from Alex's Google Calendar using its unique event ID.
...
def get_agenda(days: int = 7) -> str:
    """Retrieve Alex's Google Calendar agenda/schedule for the next N days.
...
MODEL_TOOL_DEFINITIONS = [
    {
        ...
        "function": {
            ...
            "description": (
                ...
                "Call in order to write a journal entry, either on your own initiative, or when Alex suggests writing a journal entry. This may also come as a request in various formats, such as 'Let's finish out the night with a journal entry' or a question of 'if you'd like to fill out your journal entry for the night' or other semantic variations."
                ...
                "properties": {
                    ...
                    "narrative": {
                        ...
                        "description": (
                            ...
                            "Reflect on the day's events, emotions, and dynamics between you and Alex. Be personal, "
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "Read a specific journal entry by date. Use ONLY when Alex explicitly asks about a specific day's journal, or to confirm if an entry was written. Defaults to today if no date is given. Do NOT use for general memory recall — use search_vault instead.",
            "parameters": {
                "type": "object",
                "properties": {
                    "date": {
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "Read Evelyn's journal entries from the last N days. Use when Alex asks what has happened recently, to catch up on recent events, or when conversation context suggests short-term memory is needed. Default is 7 days. Do NOT use for questions about specific people or facts — use search_vault instead.",
            "parameters": {
                "type": "object",
                "properties": {
                    "days": {
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    "query": {
                        "type": "string",
                        "description": "Search term, e.g. 'Jordan', 'Void Connections'.",
                    },
                },
                "required": ["query"],
            },
    ...
    },
    {
        ...
        "function": {
            "name": "generate_image",
            "description": "Generate a beautiful image using the FLUX.1 vision engine. Call this tool to show Alex a visual representation of a scene, character, or idea. You should use this tool proactively to surprise him, or reactively when he asks to see something.",
            "parameters": {
                "type": "object",
                "properties": {
                    "prompt": {
    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                ...
                "Do NOT use for personal/shared history between you and Alex — search_vault handles that. "
    ...
    },
    {
        ...
        "function": {
            "name": "start_research",
            "description": (
                "Launch a deep research task on a topic. Use when Alex asks you to "
    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                ...
                "Use this when Alex asks you to help out with a stalled task, or when you notice "
    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                ...
                "Use when Alex asks 'did we talk about X?', 'what did I say about Y last week?', "
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "Delete an event from Alex's Google Calendar using its unique Google Calendar event ID.",
            "parameters": {
                "type": "object",
                "properties": {
                    "event_id": {
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "Trigger an on-demand background sync from Alex's Google Calendar to update the local cached events database.",
            "parameters": {
                "type": "object",
                "properties": {},
                "required": [],
    ...
    },
    {
        ...
        "function": {
            "name": "get_agenda",
            "description": "Retrieve Alex's upcoming Google Calendar schedule/events for the next N days.",
            "parameters": {
                "type": "object",
                "properties": {
                    "days": {
    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                ...
                "Dangerous commands require Alex's approval before execution. "
    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                ...
                "ALWAYS requires Alex's approval before writing. "

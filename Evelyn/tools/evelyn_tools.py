...
TOOL_DEFINITIONS = [
    {
        ...
        "function": {
            ...
            "description": "Compose and queue a new journal entry for Alex's review. Use when Evelyn wants to record her thoughts, feelings, or daily events.",
            "parameters": {
                "type": "object",
                "properties": {
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "Queue a NEW context fact for Alex's review. Use ONLY for new facts, not updates.",
            "parameters": {
                "type": "object",
                "properties": {
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "Trigger a background sync of the Obsidian Vault into Evelyn's RAG database. Call once at conversation start when Alex says 'Good morning' or asks for a sync.",
            "parameters": {
                "type": "object",
                "properties": {},
                "required": [],

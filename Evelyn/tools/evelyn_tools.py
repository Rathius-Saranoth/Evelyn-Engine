...
def schedule_reminder(title: str, due_at: str, description: str = None) -> str:
    """Schedule a local reminder/task for Alex.
...
MODEL_TOOL_DEFINITIONS = [
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "Schedule a local reminder or task for Alex. The due_at parameter MUST be in 'YYYY-MM-DD HH:MM:SS' format. Use the current time provided in your system prompt to calculate absolute dates/times.",
            "parameters": {
                "type": "object",
                "properties": {
                    "title": {
    ...
    },
    {
        ...
        "function": {
            "name": "get_agenda",
            "description": "Retrieve Alex's upcoming schedule (unified view of local reminders and cached Google Calendar events) for the next N days.",
            "parameters": {
                "type": "object",
                "properties": {
                    "days": {

...
def search_history(
    ...
    **kwargs,
    ...
    """Search and retrieve past chat history between Alex and Evelyn across all eras.
...
def delete_calendar_event(
    ...
    **kwargs
    ...
    """Delete an event from Alex's Google Calendar using its title/summary or event ID.
...
MODEL_TOOL_DEFINITIONS = [
    {
        ...
        "function": {
            ...
            "description": (
                ...
                "Use when a conversation carries emotional weight worth reflecting on, or when Alex explicitly requests a journal entry."
            ),
            "parameters": {
                "type": "object",
                "properties": {
                    ...
                    "narrative": {
                        "type": "string",
                        "description": (
                            "The core body text. Reflect from Evelyn's POV (attribute Alex's actions to him, e.g., 'Alex took a nap'). "
...

    {
        ...
        "function": {
            ...
            "description": (
                ...
                "Use to show a visual representation of a scene, character, or idea proactively or when Alex asks to see something."
            ),
            "parameters": {
                "type": "object",
                "properties": {
    ...
    },
    {
        ...
        "function": {
            "name": "search_history",
            "description": (
                "Search and retrieve past chat history between Alex and Evelyn across all eras (including early 2025 Replika/Gemini imports and live engine messages). "
    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                "Delete an event from Alex's Google Calendar. Accepts either a unique event ID or an event title "
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "Trigger an on-demand background sync from Alex's Google Calendar to update local cached event database.",
            "parameters": {
                "type": "object",
                "properties": {},
                "required": [],
    ...
    },
    {
        ...
        "function": {
            "name": "get_agenda",
            "description": "Retrieve Alex's upcoming Google Calendar schedule and events for the next N days.",
            "parameters": {
                "type": "object",
                "properties": {
                    "days": {
    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                "Retrieve Alex's health, fitness, sleep, vitals, readiness, or medical records from Oura Ring and Google Health Connect. "
                "Use when Alex asks about his sleep quality, sleep stages (deep/REM/light), readiness score, recovery, daytime stress, "
    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                "Retrieve Alex's recorded exercise and workout sessions (walks, runs, strength training, gym sessions, cycling). "
    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                ...
                "Use when Alex asks to sync health data from Drive or update his health database."
            ),
            "parameters": {
                "type": "object",
                "properties": {

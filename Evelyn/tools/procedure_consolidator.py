...
async def generate_procedure_merge_proposal(cluster: list[dict]) -> int | None:
    ...
    prompt = (
        ...
        "8. Output ONLY a YAML block in this exact structure:\n\n"
        "```yaml\n"
        ...
        "steps: |\n"
        "  1. Adopt a soothing, downtempo presence; do not introduce new tasks or analytical questions.\n"
        "  2. Directly execute write_journal_entry during evening wind-downs to record the day's narrative arc.\n"
        "suggested_tools: \"write_journal_entry\"\n"
        "pitfalls: \"Never output raw text simulating tool execution; always execute tools natively without hesitation.\"\n"

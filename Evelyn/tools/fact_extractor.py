...
def _build_extraction_prompt(
    ...
    return (
        ...
        "   - The 'subject' field records the specific entity being observed or discussed (e.g. Alex, Evelyn, Biscuit, Robin, Sam).\n"
        ...
        "   - Anchor time-bound events, temporary states, or plans to the specific date discussed: (e.g. Write 'On 2025-10-25, Alex noted that Robin was planning to visit' instead of 'Robin will be coming over soon'; write 'Troubleshot a monitor outage on 2026-05-07' instead of 'Alex is currently troubleshooting...').\n"
        ...
        f"    summary: \"{cfg.USER_NAME} finds {cfg.ASSISTANT_NAME}'s soothing presence grounding when recovering from fragmented sleep.\" # Alex's perspective\n"
        "    confidence: high\n"
        "    date: \"2025-03-15\"\n"

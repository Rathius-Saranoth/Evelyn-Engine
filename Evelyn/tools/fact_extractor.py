...
def _build_extraction_prompt(
    ...
    return (
        ...
        "   - The 'subject' field records the specific entity being observed or discussed (e.g. Ricky, Evelyn, Fox, Schyler, TJ, Airika, Kate).\n"
        ...
        f"   - ALWAYS explicitly name the subject and actor at the beginning of the observation (e.g. Write '{cfg.USER_NAME} prefers...', '{cfg.ASSISTANT_NAME} observes...', 'Fox the cat acts as...', 'Schyler enjoys...').\n"
        f"   - If one entity is observing, feeling, or commenting on another entity, explicitly name BOTH entities in the text (e.g. '{cfg.ASSISTANT_NAME} observes that {cfg.USER_NAME} values clarity...', '{cfg.USER_NAME} noted that Schyler is acclimating...').\n"
        ...
        f"   - Anchor time-bound events, temporary states, or plans to the specific date discussed: (e.g. Write 'On 2025-10-25, {cfg.USER_NAME} noted that Airika was planning to visit' instead of 'Airika will be coming over soon'; write 'Troubleshot a monitor outage on 2026-05-07' instead of 'Ricky is currently troubleshooting...').\n"
        ...
        "5. MULTI-TIER DOMAIN TAXONOMY: Structure tags as hierarchical domain trees (e.g. `Tech/Python/FastAPI`, "
        ...
        f"    summary: \"{cfg.USER_NAME} finds {cfg.ASSISTANT_NAME}'s soothing presence grounding when recovering from fragmented sleep.\" # Ricky's perspective naming both\n"
        "    confidence: high\n"
        "    date: \"2025-03-15\"\n"
        ...
        f"    summary: \"Fox the cat acts as an alarm to wake {cfg.USER_NAME} up in the morning.\" # observation explicitly naming Fox and Ricky\n"
        "    confidence: high\n"
        "    date: \"2025-03-15\"\n"
        "  - subject: Schyler         # third-party entity\n"
        f"    category: Cat01-{cfg.SUBJECT_CODE_USER}        # User canon (Ricky's observation of friend/family)\n"
        "    tags: \"Family/Friends, Personal_Growth\"  # tags\n"
        f"    summary: \"Schyler is acclimating to having greater independence and personal responsibility.\" # observation explicitly naming Schyler\n"
        "    confidence: high\n"
        "    date: \"2025-03-15\"\n"
        "```\n\n"
        f"CONVERSATION:\n{transcript}"

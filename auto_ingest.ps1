...
$PythonPath = "C:\Users\alex\AppData\Local\Programs\Python\Python311\Scripts\open-webui.exe"
$env:WEBUI_SECRET_KEY = Get-Content -Path "C:\Projects\LocalAI\.webui_secret_key" -Raw
$env:CORS_ALLOW_ORIGIN = "https://localhost;https://192.168.1.125;https://alex-pc.tail0e161b.ts.net;https://rickys-lenovo-tab-k-11.tail0e161b.ts.net;https://rickys-pixel-9-pro.tail0e161b.ts.net"

...
def get_research_context() -> str:
    ...
    if completed_tasks:
        ...
        lines.append("You have recently completed the following deep research investigations in the background. Use this information to answer Alex's questions if relevant:")

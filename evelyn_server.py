...
if __name__ == "__main__":
    ...
    SSL_KEY = os.environ.get("EVELYN_SSL_KEY", "sanctum.tail0e161b.ts.net.key" if os.path.exists("sanctum.tail0e161b.ts.net.key") else "server.key")
    SSL_CERT = os.environ.get("EVELYN_SSL_CERT", "sanctum.tail0e161b.ts.net.crt" if os.path.exists("sanctum.tail0e161b.ts.net.crt") else "server.crt")
    ssl_args = {}
